    ...
    try {
      ...
      for (const key of knownFields) {
        if ((data as any)[key] !== undefined) {
          cleanedData[key] = (data as any)[key] || null;
        }
      }

      // Bos tarihleri null yap
      ...
      // Cocuk bilgilerini JSON olarak kaydet
        ...
        <div className="card p-8">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="form-section bg-indigo-500/5 border-indigo-500/20">
              <h3 className="text-lg font-bold text-indigo-400 mb-6">Temel Bilgiler</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input {...register('birth_year', { valueAsNumber: true })} type="number" className="input-field" placeholder="1990" />
                </div>
                <div>
                  <label className="form-label">TC Kimlik No *</label>
                  <input {...register('tc_number', { required: true })} maxLength={11} className="input-field" />
                </div>
              </div>
            </div>
            ...
            <div className="form-section bg-emerald-500/5 border-emerald-500/20">
              <h3 className="text-lg font-bold text-emerald-400 mb-6">Dogum Yeri</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
            ...
            <div className="form-section bg-violet-500/5 border-violet-500/20">
              <h3 className="text-lg font-bold text-violet-400 mb-6">Diger Bilgiler</h3>
            ...
            <div className="form-section bg-rose-500/5 border-rose-500/20">
              <h3 className="text-lg font-bold text-rose-400 mb-6">Calisma Tarihleri</h3>
            ...
            <div className="form-section bg-cyan-500/5 border-cyan-500/20">
              <h3 className="text-lg font-bold text-cyan-400 mb-6">Iletisim</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            {maritalStatus === 'Married' && (
              <div className="form-section bg-pink-500/5 border-pink-500/20">
                <h3 className="text-lg font-bold text-pink-400 mb-6">Es Bilgileri</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="form-label">Es Adi</label>
                    <input {...register('spouse_first_name')} className="input-field" />
                  </div>
                  <div>
                    <label className="form-label">Es Soyadi</label>
                    <input {...register('spouse_last_name')} className="input-field" />
                  </div>
                  <div>
                    <label className="form-label">Dogum Tarihi</label>
                    <input {...register('spouse_birth_date')} type="date" className="input-field" />
                  </div>
                  <div>
                    <label className="form-label">Dogum Ulkesi</label>
                    <input {...register('spouse_birth_country')} className="input-field" />
                  </div>
                  <div>
                    <label className="form-label">Dogum Sehri</label>
                    <input {...register('spouse_birth_city')} className="input-field" />
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="form-section bg-blue-500/5 border-blue-500/20">
              <h3 className="text-lg font-bold text-blue-400 mb-6">Ebeveyn Bilgileri</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <h4 className="text-slate-200 font-semibold border-b border-slate-700 pb-2">Baba</h4>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="form-label">Ad</label>
                      <input {...register('father_first_name')} className="input-field" />
                    </div>
                    <div>
                      <label className="form-label">Soyad</label>
                      <input {...register('father_last_name')} className="input-field" />
                    </div>
                  </div>
                  <div>
                    <label className="form-label">Milliyet</label>
                    <input {...register('father_nationality')} className="input-field" />
                  </div>
                  <div>
                    <label className="form-label">Dogum Tarihi</label>
                    <input {...register('father_birth_date')} type="date" className="input-field" />
                  </div>
                </div>
                <div className="space-y-4">
                  <h4 className="text-slate-200 font-semibold border-b border-slate-700 pb-2">Anne</h4>
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="form-label">Ad</label>
                      <input {...register('mother_first_name')} className="input-field" />
                    </div>
                    <div>
                      <label className="form-label">Soyad</label>
                      <input {...register('mother_last_name')} className="input-field" />
                    </div>
                  </div>
                  <div>
                    <label className="form-label">Milliyet</label>
                    <input {...register('mother_nationality')} className="input-field" />
                  </div>
                  <div>
                    <label className="form-label">Dogum Tarihi</label>
                    <input {...register('mother_birth_date')} type="date" className="input-field" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="form-section bg-yellow-500/5 border-yellow-500/20">
              <h3 className="text-lg font-bold text-yellow-400 mb-6">Cocuk Bilgileri</h3>
              <div className="mb-4">
                ...
                <div className="space-y-4 mt-4">
                  {Array.from({ length: childrenCount }, (_, i) => (
                    <div key={i} className="border border-yellow-500/20 rounded-xl p-4 bg-yellow-500/5">
                      <h4 className="font-semibold text-yellow-300 mb-4">{i + 1}. Cocuk</h4>
